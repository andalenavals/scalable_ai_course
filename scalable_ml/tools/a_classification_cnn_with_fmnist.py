...
from scalable_ml.first_exercise.ml_models import ConvolutionalNeuralNetwork
from scalable_ml.training import train_model
import scalable_ml.model_utilities as util

import os
OUTPUT_PATH='../output/fmnist_classification_convolutionalNN'
...
def main(train=True):
    ...
    #print(train_loader.dataset.images.shape)  #(nimages, C, H, W)
    ...
    if train:
        ...
        util.store_model(ml_model, OUTPUT_PATH, f'fmnist_model_cnn.pth')
        ...
        util.load_model(ml_model, OUTPUT_PATH, f'fmnist_model_cnn.pth')
        ml_model.eval()
